...
UBUNTU_LTS_X64_URL=http://releases.ubuntu.com/14.04.3/ubuntu-14.04.3-desktop-amd64.iso
UBUNTU_LTS_X86_URL=http://releases.ubuntu.com/14.04.3/ubuntu-14.04.3-desktop-i386.iso
UBUNTU_NONPAE_URL=ftp://ftp.heise.de/pub/ct/projekte/ubuntu-nonpae/ubuntu-12.04.4-nonpae.iso
DEBIAN_X64_URL=http://cdimage.debian.org/debian-cd/current-live/amd64/iso-hybrid/debian-live-8.3.0-amd64-lxde-desktop.iso
DEBIAN_X86_URL=http://cdimage.debian.org/debian-cd/current-live/i386/iso-hybrid/debian-live-8.3.0-i386-lxde-desktop.iso
GNURADIO_X64_URL=http://eu1-dist.gnuradio.org/s3/ubuntu-14.04.3-desktop-amd64-gnuradio-3.7.9.1.iso
...
SYSTEMRESCTUE_X86_URL=http://downloads.sourceforge.net/project/systemrescuecd/sysresccd-x86/4.7.1/systemrescuecd-x86-4.7.1.iso
BANKIX_X86_URL=ftp://ftp.heise.de/pub/ct/projekte/ctbankix/12.04/ctbankix-12.04.6.iso
DESINFECT_X86_URL=
