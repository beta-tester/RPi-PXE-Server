...
KALI_X64=kali-x64
KALI_X64_URL=https://cdimage.kali.org/current/kali-linux-2020.1-live-amd64.iso
...
TAILS_X64=tails-x64
TAILS_X64_URL=https://mirrors.edge.kernel.org/tails/stable/tails-amd64-4.3/tails-amd64-4.3.iso
